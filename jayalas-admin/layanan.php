    ...
    <div class="container-fluid px-3 px-md-4 py-4">
        ...
        <div class="admin-card">
            <div class="admin-card-header">
                ...
                <a href="proses/tambah-layanan.php" class="btn-tambah">
            ...
            <div class="table-scroll">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        <?php $no = 1; while ($l = mysqli_fetch_assoc($list)) { ?>
                        <tr>
                            <td class="text-muted"><?php echo $no++; ?></td>
                            <td>
                                <?php if ($l['foto']) { ?>
                                <img src="../assets/img/layanan/<?php echo htmlspecialchars($l['foto']); ?>" width="70"
                                    height="50">
                                <?php } else { ?>
                            ...
                            <td class="col-urutan"><?php echo $l['urutan']; ?></td>
                            <td>
                                <div class="d-flex gap-1">
                                    <a href="proses/edit-layanan.php?id=<?php echo $l['id']; ?>"
                                        class="btn-edit">Edit</a>
                                    <a href="layanan.php?hapus=<?php echo $l['id']; ?>" class="btn-hapus"
